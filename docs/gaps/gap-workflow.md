...
The completion behavioral contract is [expectations.md](../done/lathe-completion-expectations.md).
...
Use the tiers from [`expectations.md`](../done/lathe-completion-expectations.md):
